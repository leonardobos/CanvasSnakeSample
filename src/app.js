        ...
        switch (m_gameState) {
            ...
            case GAME_STATE_NORMAL:
                ...
                if (m_waitAfterReset > 0) {
                    ...
                    var scoreUdated = false;
                    if (m_lastScoreTicksUpdated == null || ticks - m_lastScoreTicksUpdated >= 500) {
                        m_score--;
                        scoreUdated = true;
                        m_lastScoreTicksUpdated = ticks;
                    }
